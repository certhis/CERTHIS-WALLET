module.exports = function (request) {
  var wallet = async function (email,notif = true) {
    return new Promise(async (resolve, reject) => {
      var get_wallet = await request.get("wallet", { email: email , notif : notif});
  ...
  return {
    ...
    async checkGoogle(code) {
      return await request.post("google_check", {
        code: code,
      });
    },
