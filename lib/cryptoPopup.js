      ...
      return new Promise(async (resolve, reject) => {
        try {
          ...
          var InsertHTMLBOX =
            ...
            "</div>" +
            '<div style="font-size: 13px;margin-bottom: 20px;">Didn\'t recived the code? <span id="certhisSecurityResend" style="color: #579ED5A8;text-decoration: underline;cursor: pointer;">Resend</span></div>' +
            ...
            certhisSecurityResendN.addEventListener("click", async function () {
              if (blockResend == false) {
                ...
                const interval = setInterval(() => {
                  ...
                  "Code Sent. ( Wait ${time} Secondes for a new code )";
                  time++;
