    ...
    return new Promise(async (resolve, reject) => {
      ...
      if (get_tx != null) {
        ...
        if (get_tx.value != undefined) {
          ...
          '<div style="display: inline-block;width: 50%;text-align: left;padding-left: 15px;font-size: 20px;">Value</div>'+
          '<div style="display: inline-block;width: 50%;text-align: right;padding-right: 15px;font-size: 20px;">0 '+rpcinfo.currency_array[localStorage.getItem("RPC_ID_CERTHIS")]+'</div>'+
          '</div>';
        }
