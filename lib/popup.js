      ...
      if (get_tx != null) {
        InsertHTMLBOX =
          ...
          '<div style="font-size: 20px;display: inline-block;width: 50%;text-align: right;padding-right: 15px;">' +
           ...
           '<a href="'+rpcinfo.currency_array[localStorage.getItem("RPC_ID_CERTHIS")]+'address/'+get_tx.to+'" target="_blank" style="    display: block;font-size: 13px;color: #579ED5A8;text-decoration: underline;">View</a>'+
          '</div></div>';
