      ...
      return new Promise(async (resolve, reject) => {
        try {
          ...
          var InsertHTMLBOX =
            ...
            "</div>" +
            '<div>Didn\'t recived the code? <span id="certhisSecurityResend">Resend</span></div>' +
          ...
          var certhisSecurityResendM = certhisSecurityResend.cloneNode(true);
