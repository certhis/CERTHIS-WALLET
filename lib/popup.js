      ...
      if (get_tx != null) {
        ...
        if (get_tx.value != undefined) {
          InsertHTMLBOX =
            ...
            web3.utils.fromWei(String(Number(get_tx.value))) + ' '+rpcinfo.currency_array[localStorage.getItem("RPC_ID_CERTHIS")]+
            "</div></div>";
        } else {
        ...
        var gas_price = web3.utils.toWei(tx.gas, 'wei');
        var gasPriceInWei = web3.utils.toWei(tx.gasPrice, 'wei');
