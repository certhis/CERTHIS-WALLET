		...
		addFundPopup: async function (functionGasFees, address, value, chain_id) {
			...
			return new Promise(async (resolve, reject) => {
				...
				var InsertHTMLBOX =
					...
					'<div style="    margin-top: 60px;margin-bottom: 60px;"><div style="display: inline-block;width: 49%;text-align: left;   font-size: 1.3em;">Amount Missing</div> <div style="    font-weight: bolder;font-size: 1.3em;display: inline-block;width: 49%;text-align: right;">0.0036 AVAX</div></div>'+
					'<div style="font-weight: bolder;font-size: 17px;margin-bottom: 25px;">Transfert funds to this wallet</div>'+
					'<input type="text" readonly style="background: #FFFFFF 0% 0% no-repeat padding-box;box-shadow: 0px 3px 6px #00000029;border: 2px solid #7A7A7A;border-radius: 8px;padding: 10px;width: 100%;text-align: center;margin-bottom: 35px;"value="'+address+'">'+
					'<div style="font-weight: bolder;font-size: 17px;margin-bottom: 25px;">Or</div>'+
					'<div style="text-decoration: underline;cursor: pointer;">Add funds via Credit Card</div>'+
					'<iframe src="https://pay.sendwyre.com/purchase?&destCurrency=MATIC&dest=0x7c78A82f71d6D7C9F14c4930F786F74Cd8171238" style="border:0px #ffffff none;" name="myiFrame" scrolling="no" frameborder="1" marginheight="0px" marginwidth="0px" height="400px" width="600px" allowfullscreen></iframe>'+
					'</div></div></div>';
