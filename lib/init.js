			...
			return new Promise(async (resolve, reject) => {
				...
				if (localStorage.getItem("CONNECTED") == "true") {
					...
					InsertHTMLBOX =
						...
						'<button class="certhisWalletConnectExternal" id="certhis-metamask-button" style="cursor: pointer;display: block;margin: auto;background: #fff;border: 1px solid;padding: 10px;font-size: 17px;border-radius: 5px;padding-right: 17px;padding-left: 17px;margin-bottom: 10px;">Metamask</button>' +
						'<button class="certhisWalletConnectExternal" id="certhis-walletconnect-button" style="cursor: pointer;display: block;margin: auto;background: #fff;border: 1px solid;padding: 10px;font-size: 17px;border-radius: 5px;padding-right: 17px;padding-left: 17px;margin-bottom: 10px;">Wallet Connect</button>' +
						'<button class="certhisWalletConnectExternal" id="certhis-coinbase-button" style="cursor: pointer;display: block;margin: auto;background: #fff;border: 1px solid;padding: 10px;font-size: 17px;border-radius: 5px;padding-right: 17px;padding-left: 17px;margin-bottom: 10px;">Coinbase Wallet</button>' +
						"</div></div>" +
