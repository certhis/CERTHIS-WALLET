    ...
    return new Promise(async (resolve, reject) => {
      ...
      if (get_tx != null) {
        InsertHTMLBOX =
          InsertHTMLBOX +
          '<div style="">' +
          '<div style="    border-bottom: 2px solid #ccc;padding-bottom: 10px;margin-bottom: 15px;"><div style="display: inline-block;width: 50%;text-align: left;padding-left: 15px;font-size: 20px;">Recipient</div><div style="display: inline-block;width: 50%;text-align: right;padding-right: 15px;">' +
        ...
        if (get_tx.value != undefined) {
          InsertHTMLBOX =
            InsertHTMLBOX +
            '<div style="    border-bottom: 2px solid #ccc;padding-bottom: 10px;margin-bottom: 15px;"><div style="display: inline-block;width: 50%;text-align: left;padding-left: 15px;font-size: 20px;">Value</div><div style="font-size: 20px;display: inline-block;width: 50%;text-align: right;padding-right: 15px;">' +
            web3.utils.fromWei(String(Number(get_tx.value))) +
            "</div></div>";
        } else {
          InsertHTMLBOX = InsertHTMLBOX + '<div><div style="display: inline-block;width: 50%;text-align: left;padding-left: 15px;font-size: 20px;">Value</div><div style="display: inline-block;width: 50%;text-align: right;padding-right: 15px;font-size: 20px;">0' + "</div></div>";
        }

        InsertHTMLBOX =
          InsertHTMLBOX +
          '<div style="    border-bottom: 2px solid #ccc;padding-bottom: 10px;margin-bottom: 15px;"><div style="font-size: 20px;display: inline-block;width: 50%;text-align: left;padding-left: 15px;font-size: 20px;">Gas Fee</div><div style="display: inline-block;width: 50%;text-align: right;padding-right: 15px;">' +
