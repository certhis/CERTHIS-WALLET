            ...
            return new Promise(async (resolve, reject) => {
                ...
                if (balance >= amount_missing) {
                    ...
                    var InsertHTMLBOX =
                        ...
                        '<input type="text" readonly style="background: #FFFFFF 0% 0% no-repeat padding-box;    border: none;    border-radius: 8px;    font-size: 16px;    height: 42px;    width: 100%;    text-align: center;    margin-bottom: 35px;    background: #F8F8F8;    border-radius: 8px;" value="' +
                        address +
                        '">';
                    ...
                    InsertHTMLBOX =
                        ...
                        'src="https://widget.onramper.com?apiKey=pk_test_wE4B5qcOzGu0N2Rm0PGi8UDEOiYojKDS8cdL3c6Fkig0&color=000&darkMode=false&defaultCrypto=' +rpcinfo.currency_array[chain_id] +'"&onlyCryptos=ETH&isAddressEditable=false&isAmountEditable=true&wallets=ETH:&display=swap&defaultAmount=100&supportSwap=false' +
                        String(amount_missing) +'"&walletAddress=' +address +'&cryptoCurrencyCode=' +rpcinfo.currency_array[chain_id] +'frameborder="no" allowtransparency="true" allowfullscreen="" style="    display: block;max-width: 97%;width:500px;margin: auto;height: 600px;max-height: 625px;margin-bottom: 10px;">' +
                        "</iframe></div>" +
                        "</div>";
