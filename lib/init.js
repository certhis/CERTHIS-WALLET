            ...
            return new Promise(async (resolve, reject) => {
                ...
                if (localStorage.getItem("CONNECTED") == "true") {
                    ...
                    InsertHTMLBOX =
                        ...
                        '">' +
                        '<img src="https://utility-apps-assets.certhis.io/certhisWallet/wallet_logo/certhis_wallet.png" style="max-height: 50px;margin-top: 35px;" >' +
                        ...
                        '<div  style="font-size: 15px;    margin-bottom: 25px;color: #807979;font-weight: 300;">Use your email directly and start navigating<br>on Web3 instantly.</div>' +
                        '<div id="' +
                        id_insert +
                        ...
                        '<div style="margin-bottom: 35px; margin-top: 35px; font-size: 14px; color: #807979;"> Or </div>' +
                        '<button id="' +
                        id_insert +
                        ...
                        '<button  id="' +
                        id_insert +
                        '-certhis-walletconnect-button" style="color: #000000;cursor: pointer;display: block;margin: auto;padding: 10px;font-size: 15px;padding-right: 17px;padding-left: 17px;margin-bottom: 30px;margin-top:20px;border-radius: 31px;border: none;min-width: 300px;max-width: 100%;background: #F8F8F8;border-radius: 8px;"><img src="https://utility-apps-assets.certhis.io/certhisWallet/wallet_logo/3.png"  style="vertical-align: middle;height: 30px;margin-right: 10px;" ><div style="width: fit-content;display: inline-block;vertical-align: initial;background: linear-gradient(90.17deg, #721AFF -34.45%, #04AB93 122.65%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;background-clip: text;text-fill-color: transparent;border: 1px solid #000000;border-radius: 59px;padding: 4px;font-size: 15px;padding-right: 15px;padding-left: 15px;padding-top: 5px;line-height: 21px;">Connect</div></button>' +
                        '<button id="' +
                        id_insert +
                        ...
                        '</div><div style="font-size: 12px;color: #807979;width: 250px;margin: auto;margin-top: 40px;">* By connecting your wallet, you accept our <a href="https://certhis.io/terms-of-use">Terms of Use</a> and acknowledge that you have read our <a href="https://certhis.io/privacy-policy">Privacy Policy</a>.</div></div>' +
                    ...
                    document.body.appendChild('<style>.certhisWalletStyle a {color:#000 !important} </style>');
