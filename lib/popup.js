  ...
  var show_popup = function (
    ...
    return new Promise(async (resolve, reject) => {
      ...
      var InsertHTMLBOX =
        ...
        '<div id="closePopupLib" style="position: absolute;width: fit-content;right: 26px;cursor: pointer;top: 13px;font-size: 25px;color: #707070;font-weight: 100;font-family: system-ui;">X</div>' +
