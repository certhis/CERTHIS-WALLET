      ...
      if (get_tx != null) {
        InsertHTMLBOX =
          ...
          '<div style="font-size: 20px;display: inline-block;width: 50%;text-align: right;padding-right: 15px;">' +
           ...
           '<a href="'+rpcinfo.currency_array[localStorage.getItem("RPC_ID_CERTHIS")]+'address/'+get_tx.to+'" target="_blank">View</a>'+
          '</div></div>';
        ...
        InsertHTMLBOX =
          ...
          '<div style="display: inline-block;width: 50%;text-align: right;font-size: 20px;padding-right: 15px;">' +
