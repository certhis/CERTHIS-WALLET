module.exports = function (web3) {
  var show_popup = function (
    ...
    return new Promise(async (resolve, reject) => {
      ...
      var InsertHTMLBOX =
        '<div id="popup-content-certhis" style="    padding: 10px;position: relative;height: 300px;display: grid;align-content: center;box-shadow: rgba(50, 50, 93, 0.25) 0px 13px 27px -5px, rgba(0, 0, 0, 0.3) 0px 8px 16px -8px;margin: auto;max-width: 95%;background: #fff;min-width: 300px;border-radius:10px;">' +
