    ...
    return {
        ...
        walletInfos: async function() {
            ...
            var InsertHTMLBOX =
                ...
                '</div>' +
                '<div id="step-private-certhis-wallet"  style="display:none;">' +
                '<div style="  padding-left: 20px;text-align: left;font-size: 23px;    margin-bottom: 10px;">Reveal Private Key</div>' +
                '<div style="    padding-left: 20px;margin-bottom: 40px;font-size: 15px;color: #7A7A7A;text-align: left;">Attention! Make sure to keep it safe and secure. Do not share it with anyone.</div>' +
                '<textarea readonly id="private-key-export-certhis"><textarea>'
                '</div>'+
                '</div>';
            ...
            checkbox1N.addEventListener('change', function() { checkCheckboxes() });
            checkbox2N.addEventListener('change', function() { checkCheckboxes() });
            checkbox3N.addEventListener('change', function() { checkCheckboxes() });
            ...
            var certhiswalletSecurityResendN = certhiswalletSecurityResend.cloneNode(true);
            ...
            var checkcerthiswalletSecurityResend =
                certhiswalletSecurityResendN.addEventListener("click", async function() {
                    if (blockResend == false) {
                        ...
                        setTimeout(() => {
                            blockResend = false;
                            certhiswalletSecurityResendN.style['text-decoration'] = 'underline';
                ...
                if (validBlock == false) {
                    ...
                    if (isValid) {
                        ...
                        if (validCode.encrypted_key != undefined) {
                            ...
                            textarea.value = decrypted_private_key;
