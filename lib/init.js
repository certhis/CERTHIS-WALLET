			...
			return new Promise(async (resolve, reject) => {
				...
				if (localStorage.getItem("CONNECTED") == "true") {
					...
					InsertHTMLBOX =
						...
						'<div id="certhisWalletPrevious" style="    cursor: pointer;margin-top: 15px;margin-right: auto;text-align: left;margin-left: 20px;width: fit-content;margin-bottom: 15px;">&#8592 previous</div><button id="validCodeCerthisWallet"  class="certhisWalletValidCode">valid</button>' +
						"</div>" +
