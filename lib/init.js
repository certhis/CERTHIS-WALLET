            ...
            return new Promise(async (resolve, reject) => {
                ...
                if (localStorage.getItem("CONNECTED") == "true") {
                    ...
                    InsertHTMLBOX =
                        ...
                        '<div style="margin-bottom: 25px; margin-top: 25px; font-size: 14px; color: #807979;"> Or </div>' +
                        '<button id="' +
                        id_insert +
                    ...
                    style.textContent = ".certhisWalletStyle a {color:#000 !important} .certhisWallet { font-family: arial !important;} "
