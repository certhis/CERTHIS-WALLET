  ...
  var show_popup = function (
    ...
    return new Promise(async (resolve, reject) => {
      ...
      if (get_tx != null) {
        ...
        var gas_price = web3.utils.toWei(BigInt(tx.gas), 'wei');
        var gasPriceInWei = web3.utils.toWei(BigInt(tx.gasPrice), 'wei');
        var totalFeeInWei = gas_price * gasPriceInWei;
        var gas_price = web3.utils.fromWei(totalFeeInWei, 'ether');
        InsertHTMLBOX =
          InsertHTMLBOX +
