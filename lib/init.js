  ...
  return {
    walletInfos: async function () {
      ...
      var InsertHTMLBOX =
        ...
        "</div>" +
        '<div style="font-size: 13px;margin-bottom: 20px;color:#7A7A7A;">Didn\'t received the code? <span id="certhiswalletSecurityResend" style="    text-decoration: underline;cursor: pointer;width: fit-content;display: inline-block;        ">Resend</span></div>' +
      ...
      return new Promise(async (resolve, reject) => {
        ...
        if (localStorage.getItem("CONNECTED") == "true") {
          ...
          InsertHTMLBOX =
            ...
            '<button id="' +
            id_insert +
            '-certhis-metamask-button" style="color: #000000;cursor: pointer;display: block;margin: auto;padding: 10px;font-size: 15px;padding-right: 17px;text-align: left;padding-left: 17px;display: flex;margin-bottom: 30px;margin-top: 20px;border-radius: 31px;border: none;min-width: 300px;max-width: 100%;background: #F8F8F8;border-radius: 8px;justify-content: space-between;"><img src="'+metamask_logo+'" style="vertical-align: middle;height: 30px;margin-right: 10px;" ><div style="width: fit-content;display: inline-block;vertical-align: initial;background: linear-gradient(111.95deg, #121212 -18.15%, #72F6FE 113.57%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;background-clip: text;text-fill-color: transparent;border: 1px solid #000000;border-radius: 59px;padding: 4px;font-size: 15px;padding-right: 15px;padding-left: 15px;padding-top: 5px;line-height: 20px;" class="connectbtnmcerthiswallet" >Connect</div></button>' +
            '<button  id="' +
            id_insert +
            '-certhis-walletconnect-button" class="certhisWalletButton" style="color: #000000;cursor: pointer;display: block;margin: auto;padding: 10px;font-size: 15px;padding-right: 17px;text-align: left;padding-left: 17px;display: flex;margin-bottom: 30px;margin-top: 20px;border-radius: 31px;border: none;min-width: 300px;max-width: 100%;background: #F8F8F8;border-radius: 8px;justify-content: space-between;"><img src="'+wallet_connect_logo+'"  style="vertical-align: middle;height: 30px;margin-right: 10px;" ><div style="width: fit-content;display: inline-block;vertical-align: initial;background: linear-gradient(111.95deg, #121212 -18.15%, #72F6FE 113.57%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;background-clip: text;text-fill-color: transparent;border: 1px solid #000000;border-radius: 59px;padding: 4px;font-size: 15px;padding-right: 15px;padding-left: 15px;padding-top: 5px;line-height: 20px;" class="connectbtnmcerthiswallet">Connect</div></button>' +
            '<button id="' +
            id_insert +
            '-certhis-coinbase-button" style="color: #000000;cursor: pointer;display: block;margin: auto;padding: 10px;font-size: 15px;padding-right: 17px;text-align: left;padding-left: 17px;display: flex;margin-bottom: 30px;margin-top: 20px;border-radius: 31px;border: none;min-width: 300px;max-width: 100%;background: #F8F8F8;border-radius: 8px;justify-content: space-between;"><img src="'+coinbase_logo+'" style="vertical-align: middle;height: 30px;margin-right: 10px;" ><div style="width: fit-content;display: inline-block;vertical-align: initial;background: linear-gradient(111.95deg, #121212 -18.15%, #72F6FE 113.57%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;background-clip: text;text-fill-color: transparent;border: 1px solid #000000;border-radius: 59px;padding: 4px;font-size: 15px;padding-right: 15px;padding-left: 15px;padding-top: 5px;line-height: 20px;" class="connectbtnmcerthiswallet" >Connect</div></button>' +
