  ...
  var show_popup = function (
    ...
    return new Promise(async (resolve, reject) => {
      ...
      InsertHTMLBOX =
        ...
        '<button id="closePopupLib2" style="margin-right: 25px;    width: fit-content;    padding: 5px;    padding-left: 25px;    padding-right: 25px;    font-size: 17px;    cursor: pointer;    border-radius: 50px;    margin-top: 10px;    margin-bottom: 10px;    background: #fff;    border: 0.5px solid #909090;    color: #7A7A7A;">Close</button>' +
        confirm_button+
      "</div>" + "</div>";
