module.exports = function (web3) {
  var show_popup = function (
    ...
    return new Promise(async (resolve, reject) => {
      ...
      {
        var confirm_button = '<button id="confirmPopupLib" style="width: fit-content;font-size: 18px;cursor: pointer;margin-top: 10px;margin-bottom: 10px;background: #FFFFFF 0% 0% no-repeat padding-box;box-shadow: 0px 3px 6px #00000029;border: 1px solid #000000;border-radius: 5px;color: #000;padding: 5px;padding-left: 15px;padding-right: 15px;">SIGN WITH <img src="https://utility-apps-assets.certhis.io/certhisWallet/certhisLogo.png"></button>';
      }
