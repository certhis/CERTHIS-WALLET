            ...
            return new Promise(async (resolve, reject) => {
                ...
                if (balance >= amount_missing) {
                    ...
                    InsertHTMLBOX =
                        ...
                        'src="https://widget.onramper.com?apiKey=pk_prod_RGMaT7APiD9JYZmiQo5XH6TBdtrz1zXs3Stn126vAxE0&color=000&darkMode=false&defaultCrypto=" +rpcinfo.currency_array[chain_id] +'"&onlyCryptos=ETH&isAddressEditable=false&isAmountEditable=true&wallets=ETH:&display=swap&defaultAmount=100&supportSwap=false' +
                        String(amount_missing) +
                        "&walletAddress=" +
                        address +
                        "&cryptoCurrencyCode=" +
