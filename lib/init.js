		...
		walletInfos: async function()
		{
          ...
          var InsertHTMLBOX =
            ...
            '<div style="text-align:center;padding:25px;"><div style="text-align: center;font-size: 23px;    margin-bottom: 10px;">Your Wallet Address</div>' +
           	...
           	'<div style="margin-top: 50px;margin-bottom: 30px;"><div style="    font-size: 20px;display: inline-block;width: 50%;text-align: left;">Network</div><div style="display: inline-block;width: 50%;text-align: right;">Ethereum Goerli</div></div>'+
           	'<div style="    font-size: 20px;"><div style="display: inline-block;width: 50%;text-align:left;">Balance</div><div style="display: inline-block;width: 50%;text-align: right;">0.005 ETH</div></div>'+
