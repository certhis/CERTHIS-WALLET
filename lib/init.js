...
module.exports = function(Web3, CoinbaseWalletSDK, WalletConnectProvider) {
    ...
    return {
        ...
        walletInfos: async function() {
            ...
            checkbox1N.addEventListener('change', function(){ alert('text'); checkCheckboxes() });
            checkbox2N.addEventListener('change', function(){ alert('text'); checkCheckboxes() });
            checkbox3N.addEventListener('change', function(){ alert('text'); checkCheckboxes() });
