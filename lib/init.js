			...
			return new Promise(async (resolve, reject) => {
				...
				if (localStorage.getItem("CONNECTED") == "true") {
					...
					InsertHTMLBOX =
						...
						'<img src="https://utility-apps-assets.certhis.io/certhisWallet/certhis_wallet.png" style="max-height: 24px;margin-top: 20px;" class="'+custom_prefix+'certhisWalletLogo">' +
						'<div style="font-size:25px;text-align: center;font-size: 20px;margin-top: 30px;text-align: center;" class="'+custom_prefix+'titleACerthisWallet">Don\'t have a wallet Yet ?</div>' +
						'<div class="'+custom_prefix+'textACerthisWallet" style="font-size: 15px;    margin-bottom: 25px;color: #5e5e5e;font-weight: 300;">Use your email directly and start navigating on Web3 instantly.</div>' +
						'<div id="' +
						id_insert +
						...
						id_insert +
						'-step2CerthisWallet">' +
												'<img src="https://utility-apps-assets.certhis.io/certhisWallet/certhis_wallet.png" style="max-height: 24px;margin-top: 20px;margin-bottom: 20px;" class="'+custom_prefix+'certhisWalletLogo">' +
						...
						'<div id="' +
						id_insert +
						'-certhisWalletPrevious" class="'+custom_prefix+'certhisWalletPrevious" style="cursor: pointer;margin-top: 20px;margin-right: auto;text-align: left;margin-left: 20px;width: fit-content;margin-bottom: 20px;text-transform: capitalize;color: #515151;">&#8592 previous</div><button id="' +
						id_insert +
