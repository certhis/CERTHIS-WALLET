			...
			return new Promise(async (resolve, reject) => {
				...
				if (localStorage.getItem("CONNECTED") == "true") {
					...
					InsertHTMLBOX =
						...
						'<div style="font-size:25px;margin-bottom: 20px;text-align: center;" class="'+custom_prefix+'titleACerthisWallet">Don\'t have a wallet Yet ?</div>' +
						'<div class="'+custom_prefix+'textACerthisWallet">Use directly your email and start navigate on Certhis</div>' +
						'<div id="' +
						id_insert +
						...
						id_insert +
						'-certhisWalletEmail" placeholder="your email" style="display: block;margin: auto;margin-bottom: 20px;">' +
						'<button id="' +
						id_insert +
						'-connectCerthis" class="'+custom_prefix+'certhisWalletConnectButton">Connect</button>' +
						"</div>" +
						'<div class="'+custom_prefix+'certhisWalletPart2">' +
						'<div style="margin-bottom: 15px;font-size: 20px;" class="'+custom_prefix+'titleBCerthisWallet">Or Connect With</div>' +
