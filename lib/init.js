    ...
    return {
        ...
        walletInfos: async function() {
            ...
            var InsertHTMLBOX =
                ...
                '</div>' +
                '<div id="step-code-certhis-wallet"  style="display:none;padding:25px;">' +
                '<div style="  padding-left: 20px;text-align: left;font-size: 23px;    margin-bottom: 10px;">Security Verification</div>' +
                '<div style="    padding-left: 20px;margin-bottom: 40px;font-size: 15px;color: #7A7A7A;width: 82%;text-align: left;">You have received a code via email.<br>Please enter the code to continue.</div>' +
