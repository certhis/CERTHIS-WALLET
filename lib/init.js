		...
		addFundPopup: async function (functionGasFees, address, value, chain_id) {
			...
			return new Promise(async (resolve, reject) => {
				...
				var InsertHTMLBOX =
					...
					'<div style="margin-top: 50px;margin-bottom: 50px;"><div style="display: inline-block;width: 49%;text-align: left;   font-size: 1.3em;    margin-top: 60px;margin-bottom: 60px;">Amount Missing</div> <div style="    font-weight: bolder;font-size: 1.3em;display: inline-block;width: 49%;text-align: right;">0.0036 AVAX</div></div>'+
