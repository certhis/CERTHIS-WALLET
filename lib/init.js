...
module.exports = function (api_key = null) {
  ...
  return {
    ...
    run: async function (args) {
      ...
      if (
        (api_key != null &&
          storageC.localStorageAdaptater.getItem("certhis_brand_info") ==
            null) ||
        storageC.localStorageAdaptater.getItem("certhis_brand_info") ==
          undefined ||
        storageC.localStorageAdaptater.getItem("certhis_brand_info") ==
      ...
      var close_img = "https://utility-apps-assets.certhis.io/certhisWallet/v2/certhis_close.png";
      var certhis_icon = "https://utility-apps-assets.certhis.io/certhisWallet/v2/certhis_icon.png";
      var invert_img = "";
      var d_none;
      var g_color = "#f4f4f4;";
      ...
      if (wallet_style == "white") {
        ...
        d_none = "display:none;";
        g_color = "#616161;";
        close_img = "https://utility-apps-assets.certhis.io/certhisWallet/c2ww.png";
        certhis_icon = "https://utility-apps-assets.certhis.io/certhisWallet/l2ww.png";
      }
