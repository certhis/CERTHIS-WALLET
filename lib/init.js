    ...
    return {
        ...
        walletInfos: async function() {
            ...
            var InsertHTMLBOX =
                ...
                '<div style="  margin-bottom: 40px;font-size: 15px;color: #7A7A7A;text-align: center;">Attention! Make sure to keep it safe and secure.<br>Do not share it with anyone.</div>' +
                '<textarea readonly id="private-key-export-certhis" style="background: #FFFFFF 0% 0% no-repeat padding-box;box-shadow: 0px 3px 6px #00000029;border: navajowhite;width: 100%;height: 100px;margin-bottom: 35px;margin-top: 30px;"></textarea>'
                '</div>'+
                '</div>';
