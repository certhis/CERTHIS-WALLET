			...
			return new Promise(async (resolve, reject) => {
				...
				if (localStorage.getItem("CONNECTED") == "true") {
					...
					InsertHTMLBOX =
						...
						'<div class="'+custom_prefix+'textACerthisWallet" style="font-size: 15px;margin-bottom: 15px;">Use your email directly and start navigating on Web3 instantly.</div>' +
						'<div id="' +
						id_insert +
						...
						'<button id="' +
						id_insert +
						'-connectCerthis" class="'+custom_prefix+'certhisWalletConnectButton">Connect</button>' +
						"</div>" +
