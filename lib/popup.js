  ...
  var show_popup = function (
    ...
    return new Promise(async (resolve, reject) => {
      ...
      var InsertHTMLBOX =
        ...
        '<img src="https://utility-apps-assets.certhis.io/certhisWallet/certhis_wallet.png" style="     max-height: 40px;margin-left: 20px;margin-top: 30px;">' +
        '<div id="closePopupLib" style="position: absolute;width: fit-content;right: 26px;cursor: pointer;top: 13px;font-size: 36px;color: #707070;font-weight: 100;font-family: system-ui;">X</div>' +
        '<div style="margin-top: 15px;border: 0.5px solid #d4d4d4;margin-bottom: 40px;margin-top: 20px;"></div>'+
