            ...
            return new Promise(async (resolve, reject) => {
                ...
                if (localStorage.getItem("CONNECTED") == "true") {
                    ...
                    InsertHTMLBOX =
                        ...
                        '<div  style="font-size: 15px;    margin-bottom: 25px;color: #807979;font-weight: 300;    margin-top: 10px;">Use your email directly and start navigating<br>on Web3 instantly.</div>' +
                        '<div id="' +
                        id_insert +
