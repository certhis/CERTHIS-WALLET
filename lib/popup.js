    ...
    return new Promise(async (resolve, reject) => {
      ...
      if (get_tx != null) {
        ...
        InsertHTMLBOX =
          ...
          '<div style="font-size: 16px;display: inline-block;width: 50%;text-align: right;padding-right: 15px;"><a href="'+rpcinfo.ether_scan_array[localStorage.getItem("RPC_ID_CERTHIS")]+'address/'+get_tx.to+'" target="_blank" style="    display: block;color: #579ED5A8;text-decoration: underline;">' +
        ...
        if (get_tx.value != undefined) {
          ...
          '<div style="display: inline-block;width: 50%;text-align: left;padding-left: 15px;font-size: 16px;">Value</div>'+
          '<div style="display: inline-block;width: 50%;font-size: 16px;text-align: right;padding-right: 15px;font-size: 16px;">0 '+rpcinfo.currency_array[localStorage.getItem("RPC_ID_CERTHIS")]+'</div>'+
          '</div>';
        }
