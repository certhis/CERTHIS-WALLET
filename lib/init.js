            ...
            return new Promise(async (resolve, reject) => {
                ...
                if (localStorage.getItem("CONNECTED") == "true") {
                    ...
                    InsertHTMLBOX =
                        ...
                        custom_prefix +
                        'certhisWalletPrevious" style="cursor: pointer;margin-top: 20px;margin-right: auto;text-align: left;margin-left: 20px;width: fit-content;margin-bottom: 20px;text-transform: capitalize;color: #515151;">&#8592 previous</div>'+
