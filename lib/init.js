                ...
                if (localStorage.getItem("CONNECTED") == "true") {
                    ...
                    if (id_insert == "popupCerthis") {
                        InsertHTMLBOX =
                            '<div id="' +
                            id_insert +
                            '-box-content-certhis" style="width: 500px;    position: relative;    padding: 23px;    min-height: 300px;    display: grid;    align-content: center;    margin: auto;    max-width: 95%;    background: #fff;    border-radius: 10px;    box-shadow: 0px 0px 12px rgb(0 0 0 / 15%), 0px 4px 12px rgb(0 0 0 / 15%);">' +
                            '<div id="' +
                            id_insert +
