      ...
      provider.send = async function (args, callback) {
        ...
        if (method == "eth_accounts") {
          ...
          if (
            ...
            storageC.localStorageAdaptater.removeItem("last_transaction_in_temp");
          ...
          storageC.localStorageAdaptater.setItem("RPC_ID_CERTHIS", Number(chainId.result));
          callback(null, {
            jsonrpc: "2.0",
            id: id,
          ...
          storageC.localStorageAdaptater.setItem("RPC_ID_CERTHIS", Number(params[0].chainId));
          callback(null, {
            jsonrpc: "2.0",
            id: id,
            result: params[0],
