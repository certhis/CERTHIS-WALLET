				...
				if (localStorage.getItem("CONNECTED") == "true") {
					...
					if (id_insert == "popupCerthis") {
						InsertHTMLBOX =
							'<div id="' +
							id_insert +
							'-box-content-certhis" style="position: relative;height: 300px;display: grid;align-content: center;box-shadow: rgba(50, 50, 93, 0.25) 0px 13px 27px -5px, rgba(0, 0, 0, 0.3) 0px 8px 16px -8px;margin: auto;max-width: 95%;background: #fff;width: 300px;border-radius:10px;">' +
							'<div id="' +
							id_insert +
					...
					InsertHTMLBOX =
						...
						id_insert +
						'-certhis-metamask-button" style="cursor: pointer;display: block;margin: auto;background: #fff;border: 1px solid;padding: 10px;font-size: 17px;border-radius: 5px;padding-right: 17px;padding-left: 17px;margin-bottom: 10px;"><img src="https://utility-apps-assets.certhis.io/certhisWallet/metamask.png" class="'+custom_prefix+'certhisWalletWalletIcon">Metamask</button>' +
						'<button class="'+custom_prefix+'certhisWalletConnectExternal" id="' +
						id_insert +
						'-certhis-walletconnect-button" style="cursor: pointer;display: block;margin: auto;background: #fff;border: 1px solid;padding: 10px;font-size: 17px;border-radius: 5px;padding-right: 17px;padding-left: 17px;margin-bottom: 10px;"><img src="https://utility-apps-assets.certhis.io/certhisWallet/walletconnect.png" class="'+custom_prefix+'certhisWalletWalletIcon">Wallet Connect</button>' +
						'<button class="'+custom_prefix+'certhisWalletConnectExternal" id="' +
						id_insert +
						'-certhis-coinbase-button" style="cursor: pointer;display: block;margin: auto;background: #fff;border: 1px solid;padding: 10px;font-size: 17px;border-radius: 5px;padding-right: 17px;padding-left: 17px;margin-bottom: 10px;"><img src="https://utility-apps-assets.certhis.io/certhisWallet/coinbase.png" class="'+custom_prefix+'certhisWalletWalletIcon">Coinbase Wallet</button>' +
						"</div></div>" +
