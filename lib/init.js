    ...
    return {
        ...
        walletInfos: async function() {
            ...
            var InsertHTMLBOX =
                ...
                '<div style="cursor: pointer;margin-top: 70px;text-decoration: underline;font-weight: bold;">Export my Private Key</div>' +
                '</div>' +
                '<div id="step-agree-certhis-wallet">'+
                '<div style="text-align: center;font-size: 23px;    margin-bottom: 10px;">Export my Private Key</div>'+
                '<div style="color:#7A7A7A">By exporting  the private key for : ' + localStorage.getItem("WALLET_CERTHIS") + ' you agreeing that : </div>'+
                '<div><input type="checkbox" id="checkbox-certhis-wallet-1"> As a user of Certhis\' services, you acknowledge that you have read and agreed to the terms outlined in the company\'s Terms of Service, including the risks associated with owning your own private key.</div>'+
                '<div><input type="checkbox" id="checkbox-certhis-wallet-2"> It is your responsibility to properly manage and secure this key, as well as any assets associated with it. Certhis cannot assist you in recovering, accessing, or storing your raw private key.</div>'+
                '<div><input type="checkbox" id="checkbox-certhis-wallet-3"> Certhis cannot provide customer support for any third-party wallet software you may use in conjunction with your private key, and does not guarantee compatibility or protection for these products.</div>'+
                '</div>'
                '</div>';
