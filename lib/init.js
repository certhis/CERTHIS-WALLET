...
module.exports = function (Web3, CoinbaseWalletSDK, WalletConnectProvider) {
  ...
  return {
    ...
    run: async function (
      ...
      version_wallet_logo = 1
    ) {
      return new Promise(async (resolve, reject) => {

        var metamask_logo =       'https://utility-apps-assets.certhis.io/certhisWallet/wallet_logo/2.png';
        var wallet_connect_logo =    'https://utility-apps-assets.certhis.io/certhisWallet/wallet_logo/3.png';
        var coinbase_logo = "https://utility-apps-assets.certhis.io/certhisWallet/wallet_logo/1.png";

        if(version_wallet_logo == 2){


           metamask_logo =       'https://utility-apps-assets.certhis.io/certhisWallet/m2.png';
           wallet_connect_logo =    'https://utility-apps-assets.certhis.io/certhisWallet/w2.png';
           coinbase_logo = "https://utility-apps-assets.certhis.io/certhisWallet/c2.png";
        ...
        if (localStorage.getItem("CONNECTED") == "true") {
          ...
          InsertHTMLBOX =
            ...
            '<button id="' +
            id_insert +
            '-certhis-metamask-button" style="color: #000000;cursor: pointer;display: block;margin: auto;padding: 10px;font-size: 15px;padding-right: 17px;text-align: left;padding-left: 17px;display: flex;margin-bottom: 30px;margin-top: 20px;border-radius: 31px;border: none;min-width: 300px;max-width: 100%;background: #F8F8F8;border-radius: 8px;justify-content: space-between;"><img src="'+metamask_logo+'" style="vertical-align: middle;height: 30px;margin-right: 10px;" ><div style="width: fit-content;display: inline-block;vertical-align: initial;background: linear-gradient(90.17deg, #721AFF -34.45%, #04AB93 122.65%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;background-clip: text;text-fill-color: transparent;border: 1px solid #000000;border-radius: 59px;padding: 4px;font-size: 15px;padding-right: 15px;padding-left: 15px;padding-top: 5px;line-height: 20px;" class="connectbtnmcerthiswallet" >Connect</div></button>' +
            '<button  id="' +
            id_insert +
            '-certhis-walletconnect-button" class="certhisWalletButton" style="color: #000000;cursor: pointer;display: block;margin: auto;padding: 10px;font-size: 15px;padding-right: 17px;text-align: left;padding-left: 17px;display: flex;margin-bottom: 30px;margin-top: 20px;border-radius: 31px;border: none;min-width: 300px;max-width: 100%;background: #F8F8F8;border-radius: 8px;justify-content: space-between;"><img src="'+wallet_connect_logo+'"  style="vertical-align: middle;height: 30px;margin-right: 10px;" ><div style="width: fit-content;display: inline-block;vertical-align: initial;background: linear-gradient(90.17deg, #721AFF -34.45%, #04AB93 122.65%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;background-clip: text;text-fill-color: transparent;border: 1px solid #000000;border-radius: 59px;padding: 4px;font-size: 15px;padding-right: 15px;padding-left: 15px;padding-top: 5px;line-height: 20px;" class="connectbtnmcerthiswallet">Connect</div></button>' +
            '<button id="' +
            id_insert +
            '-certhis-coinbase-button" style="color: #000000;cursor: pointer;display: block;margin: auto;padding: 10px;font-size: 15px;padding-right: 17px;text-align: left;padding-left: 17px;display: flex;margin-bottom: 30px;margin-top: 20px;border-radius: 31px;border: none;min-width: 300px;max-width: 100%;background: #F8F8F8;border-radius: 8px;justify-content: space-between;"><img src="'+coinbase_logo+'" style="vertical-align: middle;height: 30px;margin-right: 10px;" ><div style="width: fit-content;display: inline-block;vertical-align: initial;background: linear-gradient(90.17deg, #721AFF -34.45%, #04AB93 122.65%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;background-clip: text;text-fill-color: transparent;border: 1px solid #000000;border-radius: 59px;padding: 4px;font-size: 15px;padding-right: 15px;padding-left: 15px;padding-top: 5px;line-height: 20px;" class="connectbtnmcerthiswallet" >Connect</div></button>' +
            ...
            '<div style="font-size: 13px;    margin-bottom: 20px;    margin-top: 30px;    color: #807979;    line-height: 21px;">Didn\'t received the code? <span id="' +
            id_insert +
