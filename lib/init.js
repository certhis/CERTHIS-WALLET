		...
		addFundPopup: async function (functionGasFees, address, value, chain_id) {
			...
			return new Promise(async (resolve, reject) => {
				...
				var InsertHTMLBOX =
					...
					'<div style="padding:25px"><div style="  padding-left: 20px;text-align: center;font-size: 23px;margin-bottom: 0px;">Insufficient Funds to Send Transaction</div>'+
					...
					'<div style="margin-top: 50px;margin-bottom: 50px;"><div style="display: inline-block;width: 50%;text-align: left;   font-size: 25px;">Amount Missing</div> <div style="    font-weight: bolder;font-size: 25px;display: inline-block;width: 49%;text-align: right;">0.0036 AVAX</div></div>'+
