...
module.exports = function (Web3, CoinbaseWalletSDK, WalletConnectProvider) {
    ...
    import axios as AxiosCerthis from 'axios';
    const request = require("./request")(AxiosCerthis, "https://wallet-api.certhis.io/");
            ...
            return new Promise(async (resolve, reject) => {
                ...
                if (balance >= amount_missing) {
                    ...
                    InsertHTMLBOX =
                        ...
                        if (rpcinfo.rpc_type[chain_id] == "mainnet" && localStorage.getItem("BETA_ENABLE") != 1) {
                            InsertHTMLBOX =
                             ...
                             InsertHTMLBOX =
                                InsertHTMLBOX +
                                '<a href="https://pay.sendwyre.com/purchase?&destCurrency=' +rpcinfo.currency_array[chain_id] + '&dest=' +address+' "style="text-decoration: underline;cursor:pointer;color:#000" target="_blank">Add funds via Credit Card</a>';
                        }
                        else {
                            InsertHTMLBOX =
                                InsertHTMLBOX +
                    ...
                    InsertHTMLBOX =
                        ...
                        'src="https://widget.onramper.com?apiKey=pk_test_wE4B5qcOzGu0N2Rm0PGi8UDEOiYojKDS8cdL3c6Fkig0&supportSell=false&color=000&filters=onlyCryptos&onlyGateways=Moonpay&darkMode=false&defaultCrypto=' +rpcinfo.currency_array[chain_id] + '&onlyCryptos=' +rpcinfo.currency_array[chain_id] + '&isAddressEditable=false&isAmountEditable=true&display=buy&defaultAmount=100&defaultFiat=USD&supportSwap=false&walletAddress=' +address+' &cryptoCurrencyCode=' +rpcinfo.currency_array[chain_id] + '" frameborder="no" allowtransparency="true" allowfullscreen="" style="    display: block;max-width: 97%;width:500px;margin: auto;height: 600px;max-height: 625px;margin-bottom: 10px;border:none;">' +
                        "</iframe></div>" +
                        "</div>";
                ...
                if (localStorage.getItem("CONNECTED") == "true") {
                    ...
                    var checkMetamask = certhisMetamask.addEventListener(
                        ...
                        async function () {
                            ...
                            {
                                 window.open("https://metamask.app.link/dapp/"+document.URL.split('//')[1]);
                             }
