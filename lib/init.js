            ...
            return new Promise(async (resolve, reject) => {
                ...
                if (localStorage.getItem("CONNECTED") == "true") {
                    ...
                    InsertHTMLBOX =
                        ...
                        id_insert +
                        '-step2CerthisWallet">' +
                        '<img src="https://utility-apps-assets.certhis.io/certhisWallet/wallet_logo/certhis_wallet.png" style="max-height: 40px;margin-top: 20px;margin-bottom: 20px;" class="' +
                        custom_prefix +
                        'certhisWalletLogo">' +
                        '<div style="margin-bottom: 20px;"><div class="' +
                        custom_prefix +
                        'certhisWalletEmailReceive1" style="color: #807979;font-size: 15px;margin-top: 5px;">You have received a code via email.</div><div  class="' +
                        custom_prefix +
                        ...
                        id_insert +
                        '-certhis-code-1" style="width: 30px;    height: 30px;    margin-right: 3px;    display: inline-block;    border: none;    background: #F4F4F4;    border-radius: 5pxpx;    text-align: center;    font-size: 15px;" maxlength="1">' +
                        '<input type="text" class="' +
                        custom_prefix +
                        'certhisWalletCodeBox"  id="' +
                        id_insert +
                        '-certhis-code-2" style="width: 30px;    height: 30px;    margin-right: 3px;    display: inline-block;    border: none;    background: #F4F4F4;    border-radius: 5pxpx;    text-align: center;    font-size: 15px;" maxlength="1">' +
                        '<input type="text" class="' +
                        custom_prefix +
                        'certhisWalletCodeBox"  id="' +
                        id_insert +
                        '-certhis-code-3" style="width: 30px;    height: 30px;    margin-right: 3px;    display: inline-block;    border: none;    background: #F4F4F4;    border-radius: 5pxpx;    text-align: center;    font-size: 15px;" maxlength="1">' +
                        '<input type="text" class="' +
                        custom_prefix +
                        'certhisWalletCodeBox"  id="' +
                        id_insert +
                        '-certhis-code-4" style="width: 30px;    height: 30px;    margin-right: 3px;    display: inline-block;    border: none;    background: #F4F4F4;    border-radius: 5pxpx;    text-align: center;    font-size: 15px;" maxlength="1">' +
                        '<input type="text" class="' +
                        custom_prefix +
                        'certhisWalletCodeBox"  id="' +
                        id_insert +
                        '-certhis-code-5" style="width: 30px;    height: 30px;    margin-right: 3px;    display: inline-block;    border: none;    background: #F4F4F4;    border-radius: 5pxpx;    text-align: center;    font-size: 15px;" maxlength="1">' +
                    ...
                    style.textContent = ".certhisWalletStyle a {color:#000 !important} .certhisWallet { font-family: arial !important;} .certhisWalletStyle button:hover{ box-shadow: 0px 0px 4px rgb(0 0 0 / 25%), 0px 4px 4px rgb(0 0 0 / 25%);} "
