				...
				if (localStorage.getItem("CONNECTED") == "true") {
					...
					if (id_insert == "popupCerthis") {
						InsertHTMLBOX =
							'<div id="' +
							id_insert +
							'-box-content-certhis" style="width: fit-content;position: relative;    padding: 20px;min-height: 300px;display: grid;align-content: center;box-shadow: rgba(50, 50, 93, 0.25) 0px 13px 27px -5px, rgba(0, 0, 0, 0.3) 0px 8px 16px -8px;margin: auto;max-width: 95%;background: #fff;width: 300px;border-radius:10px;">' +
							'<div id="' +
							id_insert +
					...
					InsertHTMLBOX =
						...
						'-step2CerthisWallet">' +
												'<img src="https://utility-apps-assets.certhis.io/certhisWallet/certhis_wallet.png" style="max-height:50px" class="'+custom_prefix+'certhisWalletLogo">' +
						'<div style="margin-bottom: 20px;"><div class="'+custom_prefix+'certhisWalletEmailReceive1">You have received a code via email.</div><div  class="'+custom_prefix+'certhisWalletEmailReceive2">Please enter the code to log in</div></div>' +
						'<div id="' +
						id_insert +
							...
							if (value.length === 1) {
								const nextInput = document.querySelector(
									`#${id_insert}-certhis-code-${
										Number(event.target.id.split("-")[2]) + 1
									}`
								);
