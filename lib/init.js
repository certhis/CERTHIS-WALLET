				...
				if (localStorage.getItem("CONNECTED") == "true") {
					...
					if (id_insert == "popupCerthis") {
						InsertHTMLBOX =
							'<div id="' +
							id_insert +
							'-box-content-certhis" style="width: fit-content;position: relative;    padding: 20px;min-height: 300px;display: grid;align-content: center;box-shadow: rgba(50, 50, 93, 0.25) 0px 13px 27px -5px, rgba(0, 0, 0, 0.3) 0px 8px 16px -8px;margin: auto;max-width: 95%;background: #fff;border-radius:10px;">' +
							'<div id="' +
							id_insert +
					...
					InsertHTMLBOX =
						...
						'<img src="https://utility-apps-assets.certhis.io/certhisWallet/certhis_wallet.png" style="max-height:30px" class="'+custom_prefix+'certhisWalletLogo">' +
						'<div style="font-size:25px;margin-bottom: 20px;text-align: center;font-size: 20px;margin-top: 30px;text-align: center;" class="'+custom_prefix+'titleACerthisWallet">Don\'t have a wallet Yet ?</div>' +
