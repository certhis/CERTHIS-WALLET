      ...
      return new Promise(async (resolve, reject) => {
        try {
          ...
          var InsertHTMLBOX =
            ...
            "</div>" +
            '<div style="font-size: 13px;margin-bottom: 20px;">Didn\'t recived the code? <span id="certhisSecurityResend" style="text-decoration: underline;cursor: pointer;display:block;background: linear-gradient(90.17deg, #721AFF -34.45%, #04AB93 122.65%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;background-clip: text;text-fill-color: transparent;">Resend</span></div>' +
