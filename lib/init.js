...
module.exports = function (Web3) {
	...
	return {
		...
		run: async function (id_insert = "popupCerthis") {
			return new Promise(async (resolve, reject) => {
				...
				if (localStorage.getItem("CONNECTED") == "true") {
					...
					InsertHTMLBOX =
						InsertHTMLBOX +
						'<div style="font-size:25px;margin-bottom: 20px;text-align: center;">Certhis Wallet</div>' +
						...
						'<div style="margin-top: 17px;margin-bottom: 15px;font-size: 20px;">Or Connect With</div>' +
						...
						'<button style="cursor: pointer;display: block;margin: auto;background: #fff;border: 1px solid;padding: 10px;font-size: 17px;border-radius: 5px;padding-right: 17px;padding-left: 17px;margin-bottom: 10px;">Wallet Connect</button>' +
						'<button style="cursor: pointer;display: block;margin: auto;background: #fff;border: 1px solid;padding: 10px;font-size: 17px;border-radius: 5px;padding-right: 17px;padding-left: 17px;margin-bottom: 10px;">Coinbase Wallet</button>' +
						"</div>" +
