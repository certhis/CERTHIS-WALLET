        ...
        run: async function (
            ...
            return new Promise(async (resolve, reject) => {
                ...
                if (localStorage.getItem("CONNECTED") == "true") {
                    ...
                    style.textContent = ".certhisWalletStyle a {color:#000 !important} .certhisWallet { font-family: arial !important;} .certhisWalletStyle button{font-family: Arial;} .certhisWalletStyle button:hover{ box-shadow: 0px 0px 4px rgb(0 0 0 / 25%), 0px 4px 4px rgb(0 0 0 / 25%);} "
