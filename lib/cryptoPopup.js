    ...
    getDecryptedPrivate_key: async function () {
      ...
      return new Promise(async (resolve, reject) => {
        try {
          ...
          var InsertHTMLBOX =
            '<div id="certhis-security-popup-content-certhis" style="font-family: Arial !important;position: relative;display: grid;align-content: center;box-shadow: rgb(50 50 93 / 25%) 0px 13px 27px -5px, rgb(0 0 0 / 30%) 0px 8px 16px -8px;margin: auto;max-width: 95%;background: #fff;min-width: 300px;border-radius: 10px;background: #FFFFFF 0% 0% no-repeat padding-box;box-shadow: 0px 3px 6px #00000029;border-radius: 10px;">' +
            '<img src="https://utility-apps-assets.certhis.io/certhisWallet/cw.png" style="     max-height: 25px;margin-left: 20px;margin-top: 30px;">' +
            ...
            "</div>" +
            '<div style="font-size: 13px;margin-bottom: 20px;#807979;">Didn\'t received the code? <span id="certhisSecurityResend" style="text-decoration: underline;cursor: pointer;display:block;background: linear-gradient(90.17deg, #721AFF -34.45%, #04AB93 122.65%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;background-clip: text;text-fill-color: transparent;">Resend</span></div>' +
