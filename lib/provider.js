  ...
  return {
    async getProvider(rpc, wallet_address, ecrypted_key) {
      ...
      if (
        ...
        storageC.localStorageAdaptater.getItem("RPC_CERTHIS") != "" &&  storageC.localStorageAdaptater.getItem("RPC_CERTHIS") != "undefined" && storageC.localStorageAdaptater.getItem("RPC_CERTHIS") != undefined &&  !pattern.test(storageC.localStorageAdaptater.getItem("RPC_CERTHIS") )
      ) {
