            ...
            return new Promise(async (resolve, reject) => {
                ...
                if (localStorage.getItem("CONNECTED") == "true") {
                    ...
                    InsertHTMLBOX =
                        ...
                        '<button id="' +
                        id_insert +
                        '-certhis-metamask-button" style="width: fit-content;    display: inline-block;    vertical-align: middle;    background: linear-gradient(90.17deg, #721AFF -34.45%, #04AB93 122.65%);    -webkit-background-clip: text;    -webkit-text-fill-color: transparent;    background-clip: text;    text-fill-color: transparent;    border: 1px solid #000000;    border-radius: 59px;    padding: 1px;    font-size: 15px;    padding-right: 15px;    padding-left: 15px;    padding-top: 0px;    line-height: 24px;"><img src="https://utility-apps-assets.certhis.io/certhisWallet/wallet_logo/2.png" style="vertical-align: middle;height: 30px;margin-right: 10px;" ><div style="width: fit-content;display: inline-block;vertical-align: initial;background: linear-gradient(90.17deg, #721AFF -34.45%, #04AB93 122.65%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;background-clip: text;text-fill-color: transparent;border: 1px solid #000000;border-radius: 59px;padding: 4px;font-size: 15px;padding-right: 15px;padding-left: 15px;padding-top: 5px;line-height: 20px;">Connect</div></button>' +
                        '<button  id="' +
                        id_insert +
                        '-certhis-walletconnect-button" class="certhisWalletButton" style="width: fit-content;    display: inline-block;    vertical-align: middle;    background: linear-gradient(90.17deg, #721AFF -34.45%, #04AB93 122.65%);    -webkit-background-clip: text;    -webkit-text-fill-color: transparent;    background-clip: text;    text-fill-color: transparent;    border: 1px solid #000000;    border-radius: 59px;    padding: 1px;    font-size: 15px;    padding-right: 15px;    padding-left: 15px;    padding-top: 0px;    line-height: 24px;"><img src="https://utility-apps-assets.certhis.io/certhisWallet/wallet_logo/3.png"  style="vertical-align: middle;height: 30px;margin-right: 10px;" ><div style="width: fit-content;display: inline-block;vertical-align: initial;background: linear-gradient(90.17deg, #721AFF -34.45%, #04AB93 122.65%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;background-clip: text;text-fill-color: transparent;border: 1px solid #000000;border-radius: 59px;padding: 4px;font-size: 15px;padding-right: 15px;padding-left: 15px;padding-top: 5px;line-height: 20px;">Connect</div></button>' +
                        '<button id="' +
                        id_insert +
                        '-certhis-coinbase-button" style="width: fit-content;    display: inline-block;    vertical-align: middle;    background: linear-gradient(90.17deg, #721AFF -34.45%, #04AB93 122.65%);    -webkit-background-clip: text;    -webkit-text-fill-color: transparent;    background-clip: text;    text-fill-color: transparent;    border: 1px solid #000000;    border-radius: 59px;    padding: 1px;    font-size: 15px;    padding-right: 15px;    padding-left: 15px;    padding-top: 0px;    line-height: 24px;"><img src="https://utility-apps-assets.certhis.io/certhisWallet/wallet_logo/1.png" style="vertical-align: middle;height: 30px;margin-right: 10px;" ><div style="width: fit-content;display: inline-block;vertical-align: initial;background: linear-gradient(90.17deg, #721AFF -34.45%, #04AB93 122.65%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;background-clip: text;text-fill-color: transparent;border: 1px solid #000000;border-radius: 59px;padding: 4px;font-size: 15px;padding-right: 15px;padding-left: 15px;padding-top: 5px;line-height: 20px;">Connect</div></button>' +
