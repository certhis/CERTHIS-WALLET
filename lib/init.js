    ...
    return {
        ...
        addFundPopup: async function (
            ...
            return new Promise(async (resolve, reject) => {
                ...
                if (balance >= amount_missing) {
                    ...
                    if (localStorage.getItem("BETA_ENABLE") != 1) {

                        InsertHTMLBOX =
                                InsertHTMLBOX + '<div style="font-weight: bolder;font-size: 17px;margin-bottom: 25px;">Or</div>';
        ...
        disconnect: async function () {
            return new Promise(async (resolve, reject) => {
                ...
                localStorage.removeItem("BETA_ENABLE");
                resolve(null);
            });
        },
        run: async function (
