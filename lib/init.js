            ...
            return new Promise(async (resolve, reject) => {
                ...
                if (balance >= amount_missing) {
                    ...
                    if (rpcinfo.rpc_type[chain_id] == "mainnet") {
                        InsertHTMLBOX =
                            InsertHTMLBOX +
                            '<div id="showBoxTransacCerthisWallet" style="cursor:pointer">Add funds via Credit Card</div>';
                    } else {
                        InsertHTMLBOX =
                            InsertHTMLBOX +
                    ...
                    '<div id="transakFrame" style="display:none"><iframe height="625" title="Transak On/Off Ramp Widget"'+
                            ...
                            'style="    display: block;width: 97%;margin: auto;height: 400px;max-height: 625px;margin-bottom: 10px;">'+
                            '</iframe></div>'+
                    '</div>';

                    
                    console.log(InsertHTMLBOX)
