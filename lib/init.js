  ...
  var addFundPopup = async function (
    ...
    return new Promise(async (resolve, reject) => {
      ...
      if (
        ...
        if (amount_missing > 0 || balance_erc20 < erc20_amount) {
          ...
          if (transactionInformation.erc20 != true) {
            if (rpcinfo.rpc_type[chain_id] == "mainnet") {
              InsertHTMLBOX =
                InsertHTMLBOX +
                '<img style="width: 116px;max-width: 100%;" src="https://utility-apps-assets.certhis.io/certhisWallet/pay.png"><button style="display: block; margin: auto;width: 100%;border: none;    background: linear-gradient(90deg, #904AFF -31.62%, #04AB93 134.19%);border-radius: 59px;color: #fff;padding: 8px;margin-bottom: 20px;margin-top: 20px;font-family: system-ui;" id="showBoxTransacCerthisWallet">Pay via Credit Card</button>';
            } else {
              InsertHTMLBOX =
                InsertHTMLBOX +
                ...
                '"> <button style=" display: block; margin: auto;width: 100%;border: none;   background: linear-gradient(90deg, #904AFF -31.62%, #04AB93 134.19%);border-radius: 59px;color: #fff;padding: 8px;margin-bottom: 20px;margin-top: 20px;font-family: system-ui;" id="addfundfaucetcw">Add funds via Faucet (FREE)</button></a>';
            }
          }

          InsertHTMLBOX =
            InsertHTMLBOX +
            '<button  id="transferFundButton" style="  display: block; margin: auto;width: 100%;border: none;  background: linear-gradient(90deg, #904AFF -31.62%, #04AB93 134.19%);border-radius: 59px;color: #fff;padding: 8px;margin-bottom: 20px;margin-top: 20px;font-family: system-ui;">Transfer Funds</button>';
        } else {
          InsertHTMLBOX =
            InsertHTMLBOX +
        ...
        if (rpcinfo.rpc_type[chain_id] == "mainnet" && transactionInformation.erc20 != true) {
