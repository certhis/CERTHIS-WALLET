            ...
            return new Promise(async (resolve, reject) => {
                ...
                if (balance >= amount_missing) {
                    ...
                    '<div id="transakFrame" style="display:none"><iframe height="625" title="Transak On/Off Ramp Widget"'+
                            'src="https://global.transak.com?apiKey=af1a5a72-4afc-4c81-acb7-561bfa4768ff&defaultCryptoAmount='+String(amount_missing)+'&walletAddress='+address+'&cryptoCurrencyCode='+rpcinfo.currency_array[chain_id]+'"'+
