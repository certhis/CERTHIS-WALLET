			...
			return new Promise(async (resolve, reject) => {
				...
				if (localStorage.getItem("CONNECTED") == "true") {
					...
					InsertHTMLBOX =
						...
						'<input type="email" class="certhisWalletInputEmail" id="certhisWalletEmail" placeholder="your email" style="display: block;margin: auto;margin-bottom: 20px;">' +
						'<button id="connectCerthis" class="certhisWalletConnectButton">Connect</button>' +
						'</div>'+
						'<div class="certhisWalletPart2">'+
						'<div style="margin-bottom: 15px;font-size: 20px;" class="titleBCerthisWallet">Or Connect With</div>' +
						'<button class="certhisWalletConnectExternal" id="certhis-metamask-button" style="cursor: pointer;display: block;margin: auto;background: #fff;border: 1px solid;padding: 10px;font-size: 17px;border-radius: 5px;padding-right: 17px;padding-left: 17px;margin-bottom: 10px;"><img src="https://utility-apps-assets.certhis.io/certhisWallet/metamask.png" class="certhisWalletWalletIcon">Metamask</button>' +
						'<button class="certhisWalletConnectExternal" id="certhis-walletconnect-button" style="cursor: pointer;display: block;margin: auto;background: #fff;border: 1px solid;padding: 10px;font-size: 17px;border-radius: 5px;padding-right: 17px;padding-left: 17px;margin-bottom: 10px;"><img src="https://utility-apps-assets.certhis.io/certhisWallet/walletconnect.png" class="certhisWalletWalletIcon">Wallet Connect</button>' +
						'<button class="certhisWalletConnectExternal" id="certhis-coinbase-button" style="cursor: pointer;display: block;margin: auto;background: #fff;border: 1px solid;padding: 10px;font-size: 17px;border-radius: 5px;padding-right: 17px;padding-left: 17px;margin-bottom: 10px;"><img src="https://utility-apps-assets.certhis.io/certhisWallet/coinbase.png" class="certhisWalletWalletIcon">Coinbase Wallet</button>' +
						"</div></div>" +
						...
						'<input type="text" class="certhisWalletCodeBox" id="certhis-code-1" style="width: 30px;height: 30px;margin-right: 3px;display: inline-block;" maxlength="1">' +
						'<input type="text" class="certhisWalletCodeBox"  id="certhis-code-2" style="width: 30px;height: 30px;margin-right: 3px;display: inline-block;" maxlength="1">' +
						'<input type="text" class="certhisWalletCodeBox"  id="certhis-code-3" style="width: 30px;height: 30px;margin-right: 3px;display: inline-block;" maxlength="1">' +
						'<input type="text" class="certhisWalletCodeBox"  id="certhis-code-4" style="width: 30px;height: 30px;margin-right: 3px;display: inline-block;" maxlength="1">' +
						'<input type="text" class="certhisWalletCodeBox"  id="certhis-code-5" style="width: 30px;height: 30px;margin-right: 3px;display: inline-block;" maxlength="1">' +
						'<div id="certhisWalletPrevious" class="certhisWalletPrevious" style="    cursor: pointer;margin-top: 15px;margin-right: auto;text-align: left;margin-left: 20px;width: fit-content;margin-bottom: 15px;">&#8592 previous</div><button id="validCodeCerthisWallet"  class="certhisWalletValidCode">valid</button>' +
						"</div>" +
