		...
		addFundPopup: async function (functionGasFees, address, value, chain_id) {
			...
			return new Promise(async (resolve, reject) => {
				...
				var InsertHTMLBOX =
					...
					'<img src="https://utility-apps-assets.certhis.io/certhisWallet/certhisLogo.png" style="     max-height: 15px;margin-left: 20px;margin-top: 30px;">' +
					...
					'<div style="  padding-left: 20px;text-align: left;font-size: 23px;margin-bottom: 0px;">Insufficient Funds to Send Transaction' +
					"</div>";
