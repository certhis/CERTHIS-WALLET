            ...
            return new Promise(async (resolve, reject) => {
                ...
                if (balance >= amount_missing) {
                    ...
                    var InsertHTMLBOX =
                        ...
                        '<img src="https://utility-apps-assets.certhis.io/certhisWallet/wallet_logo/certhisLogo.png" style="max-height: 55px;width:auto;margin-left: 20px;margin-top: 10px;">' +
