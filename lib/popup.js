module.exports = function (web3) {
  var show_popup = function (
    ...
    return new Promise(async (resolve, reject) => {
      ...
      var InsertHTMLBOX =
        '<div id="popup-content-certhis" style="font-family: Arial !important;padding: 10px;position: relative;min-height: 300px;display: grid;align-content: center;box-shadow: rgb(50 50 93 / 25%) 0px 13px 27px -5px, rgb(0 0 0 / 30%) 0px 8px 16px -8px;margin: auto;max-width: 95%;background: #fff;min-width: 300px;border-radius: 10px;background: #FFFFFF 0% 0% no-repeat padding-box;box-shadow: 0px 3px 6px #00000029;border: 0.5px solid #707070;border-radius: 5px;">' +
        ...
        '<div style="margin-top: 15px;border: 0.5px solid #7A7A7A;"></div>'+
        '<div style="    padding-left: 10px;text-align: left;font-size: 23px;margin-bottom: 0px;margin-bottom: 15px;">' +
        title +
        "</div>";
      ...
      if (message != null) {
        InsertHTMLBOX =
          InsertHTMLBOX +
          '<div style="    padding-left: 10px;margin-bottom: 15px;font-size: 16px;color: #7A7A7A;    width: 80%;text-align: left;">' +
          message +
          "</div>";
      }
