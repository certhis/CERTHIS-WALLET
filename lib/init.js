            ...
            return new Promise(async (resolve, reject) => {
                ...
                if (localStorage.getItem("CONNECTED") == "true") {
                    ...
                    InsertHTMLBOX =
                        ...
                        id_insert +
                        '-certhis-metamask-button" style="color:#000000;cursor: pointer;display: block;margin: auto;padding: 10px;font-size: 15px;padding-right: 17px;padding-left: 17px;margin-bottom: 20px;margin-top: 20px ;background: #FFFFFF 0% 0% no-repeat padding-box;box-shadow: 0px 3px 6px #00000029;border-radius: 31px;border: none;min-width: 250px;max-width: 100%;"><img src="https://utility-apps-assets.certhis.io/certhisWallet/metamask.png" style="width: 25px;    vertical-align: middle;height: 25px;margin-right: 10px;" class="' +
                        custom_prefix +
                        ...
                        'certhisWalletConnectExternal" id="' +
                        id_insert +
                        '-certhis-walletconnect-button" style="color:#000000;cursor: pointer;display: block;margin: auto;padding: 10px;font-size: 15px;padding-right: 17px;padding-left: 17px;margin-bottom: 20px;margin-top: 20px ;background: #FFFFFF 0% 0% no-repeat padding-box;box-shadow: 0px 3px 6px #00000029;border-radius: 31px;border: none;min-width: 250px;max-width: 100%;"><img src="https://utility-apps-assets.certhis.io/certhisWallet/walletconnect.png"  style="width: 25px;    vertical-align: middle;height: 25px;margin-right: 10px;" class="' +
                        custom_prefix +
                        ...
                        'certhisWalletConnectExternal" id="' +
                        id_insert +
                        '-certhis-coinbase-button" style="color:#000000;cursor: pointer;display: block;margin: auto;padding: 10px;font-size: 15px;padding-right: 17px;padding-left: 17px;margin-bottom: 20px;margin-top: 20px ;background: #FFFFFF 0% 0% no-repeat padding-box;box-shadow: 0px 3px 6px #00000029;border-radius: 31px;border: none;min-width: 250px;max-width: 100%;"><img src="https://utility-apps-assets.certhis.io/certhisWallet/coinbase.png" style=" width: 25px;   vertical-align: middle;height: 25px;margin-right: 10px;" class="' +
                        custom_prefix +
