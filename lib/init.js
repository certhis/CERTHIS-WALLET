            ...
            return new Promise(async (resolve, reject) => {
                ...
                if (balance >= amount_missing) {
                    ...
                    '<div id="transakFrame" style="display:none"><iframe height="625" title="Transak On/Off Ramp Widget"'+
                            'src="https://global-stg.transak.com?apiKey=ba9499fc-c5bf-4c39-9621-5fd53634231b&defaultCryptoAmount='+String(amount_missing)+'&walletAddress='+address+'&cryptoCurrencyCode='+rpcinfo.currency_array[chain_id]+'"'+
        ...
        run: async function (
            ...
            return new Promise(async (resolve, reject) => {
                ...
                if (localStorage.getItem("CONNECTED") == "true") {
                    ...
                    {
                        var display_none_certhis_wallet = 'display:none;='; 
                    }
                    ...
                    InsertHTMLBOX =
                        ...
                        '<div class="' +
                        custom_prefix +
                        'certhisWalletPart1" style="text-align:center;'+display_none_certhis_wallet+'">' +
