...
module.exports = function () {
  ...
  return {
    ...
    height: 25.779px;
              ...
              top: 27px;z-index:15;"><img src="https://utility-apps-assets.certhis.io/certhisWallet/v2/certhis_close.png" style="width: 25px;
              height: 25px;"></div>`;
          }
          InsertHTMLBOX =
            InsertHTMLBOX +
            ...
            border-radius: 28px;
            background: radial-gradient(44.42% 44.42% at 50% 50%, rgba(18, 18, 18, 0.76) 0%, #121212 100%);` +
            display_none_certhis_wallet +
            '">' +
            `
            <img src="https://utility-apps-assets.certhis.io/certhisWallet/v2/certhis_icon.png" style="width: 40px;
            position: absolute;
            left: 27px;
            top: 22px;" >
            <div style="width: 100%;
    ...
    margin-bottom: 11px;
        ...
        "><div style="    white-space: nowrap;"><div style="background: radial-gradient(1465.66% 602.63% at 21.26% 58%, #72F6FE 0%, #121212 100%);
        background-clip: text;
        -webkit-background-clip: text;
        -webkit-text-fill-color: transparent;    display: inline-block;">Connect</div> with Certhis</div></div>` +
            ...
            font-style: normal;
            font-weight: 500;
            line-height: normal;display:inline-block;">or</div> Sign In</div>` +
            ...
            margin-bottom: 16px;
            align-items: center;
            justify-content: flex-start;"><img src="https://utility-apps-assets.certhis.io/certhisWallet/v2/close_p_w.png"style="width: 13px;height: 13px;" > Invalid Email Address</div>` +
            '<input type="email"  id="' +
            id_insert +
            '-certhisWalletEmail"  class="inputemailcerthiswallet" placeholder="Your email" style="margin-top: 40px;    display: block;    margin: auto;    margin-bottom: 20px;    background: #FFFFFF 0% 0% no-repeat padding-box;    border-radius: 26px;    border: 0;    padding: 13px;    padding-left: 20px;    padding-right: 20px;    background: #F8F8F8;    border-radius: 8px;    font-weight: 300;    font-size: 15px;    padding-right: 118px;color: #505050;    padding-right: 10px;width: 100%;">' +
            '<button id="' +
            id_insert +
        ...
        ">` +
            ...
            margin: auto;
            margin-top: 17px;
            margin-bottom: 29px;" class="certhiswallettou">* By connecting your wallet, you accept our <a href="https://certhis.io/terms-of-use">Terms of Use</a> and acknowledge that you have read our <a href="https://certhis.io/privacy-policy">Privacy Policy</a>.</div></div>` +
            '<div style="display:none;flex-direction: column;" id="' +
            id_insert +
            '-step2CerthisWallet">' +
            `<div style="display: flex; flex-direction: column; align-items: flex-start; border-radius: 28px; background: radial-gradient(44.42% 44.42% at 50% 50%, rgba(18, 18, 18, 0.76) 0%, #121212 100%);"> ` +
            `
            <img src="https://utility-apps-assets.certhis.io/certhisWallet/v2/certhis_icon.png" style="width: 40px;
            position: absolute;
            left: 27px;
    ...
    margin-bottom: 11px;
        ...
        -webkit-text-fill-color: transparent;    display: inline-block;">Connect</div> with Certhis</div></div>` +
            ...
            margin-bottom: 16px;
            align-items: center;
            justify-content: flex-start;"><img src="https://utility-apps-assets.certhis.io/certhisWallet/v2/close_p_w.png" style="width: 13px;height: 13px;" > Invalid Code </div>` +
            ...
            id_insert +
            '-certhis-code-1" style="width: 50px; height: 50px; margin-right: 3px; display: inline-block; border: none; border-radius: 5.594px; background: #F4F4F4; text-align: center; font-size: 21px; color: #121212;" maxlength="1">' +
            '<input type="text" class="' +
            custom_prefix +
            'certhisWalletCodeBox"  id="' +
            id_insert +
            '-certhis-code-2" style="width: 50px; height: 50px; margin-right: 3px; display: inline-block; border: none; border-radius: 5.594px; background: #F4F4F4; text-align: center; font-size: 21px; color: #121212;" maxlength="1">' +
            '<input type="text" class="' +
            custom_prefix +
            'certhisWalletCodeBox"  id="' +
            id_insert +
            '-certhis-code-3" style="width: 50px; height: 50px; margin-right: 3px; display: inline-block; border: none; border-radius: 5.594px; background: #F4F4F4; text-align: center; font-size: 21px; color: #121212;" maxlength="1">' +
            '<input type="text" class="' +
            custom_prefix +
            'certhisWalletCodeBox"  id="' +
            id_insert +
            '-certhis-code-4" style="width: 50px; height: 50px; margin-right: 3px; display: inline-block; border: none; border-radius: 5.594px; background: #F4F4F4; text-align: center; font-size: 21px; color: #121212;" maxlength="1">' +
            '<input type="text" class="' +
            custom_prefix +
            'certhisWalletCodeBox"  id="' +
            id_insert +
            '-certhis-code-5" style="width: 50px; height: 50px; margin-right: 3px; display: inline-block; border: none; border-radius: 5.594px; background: #F4F4F4; text-align: center; font-size: 21px; color: #121212;" maxlength="1">' +
            `</div>` +
            '<button id="' +
            id_insert +
        ...
        "  class="` +
            ...
            id_insert +
            '-step3CerthisWallet">' +
            `<div style="display: flex; flex-direction: column; align-items: flex-start; border-radius: 28px; background: radial-gradient(44.42% 44.42% at 50% 50%, rgba(18, 18, 18, 0.76) 0%, #121212 100%);"</div> ` +
            `
            <img src="https://utility-apps-assets.certhis.io/certhisWallet/v2/certhis_icon.png" style="width: 40px;
            position: absolute;
            left: 27px;
    ...
    margin-bottom: 11px;
        ...
        -webkit-text-fill-color: transparent;    display: inline-block;">Connect</div> with Certhis</div></div>` +
            ...
            height: 51px;"/><img alt="" src="https://utility-apps-assets.certhis.io/certhisWallet/v2/g_m.gif" id="m_g_popup"  style="width: 87px;
