	...
	return {
		...
		{	
          ...
          var InsertHTMLBOX =
            ...
            '<div style="text-align:center;padding:25px;"><div style="text-align: center;font-size: 23px;    margin-bottom: 10px;">Your Wallet Address</div>' +
           	...
           	'<div style="margin-top: 70px;text-decoration: underline;font-weight: bold;">Export my Private Key</div>'+
           	'</div>'+
           	'</div>';
